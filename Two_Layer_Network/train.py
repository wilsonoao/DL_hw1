...
from model.RNNClassifier import RNNClassifier
...
def main():
    ...
    #model.load_state_dict(torch.load('./model_RNNClassifier.pth'))
    ...
    for epoch in range(1, 21):
        ...
        torch.save(model.state_dict(), "model_RNNClassifier.pth")
